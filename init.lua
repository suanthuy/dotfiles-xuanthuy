...
require('lazy').setup {
  ...
  -- NOTE: auto pairs by nvim-autopaires
  {
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>t'] = { name = '[T]ree - Neotree', _ = 'which_key_ignore' },
      }
    end,
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- check the buffer of the current file
  ...
  -- NOTE: A git wrapper so awersome
  { 'tpope/vim-fugitive' },

  -- NOTE: Terminal manager for neovim
  ...
  -- NOTE: a command-line fuzzy finder and install fzf-lua too
  ...
  -- NOTE: Neovim plugin to manage the file system and other tree like structures
  {
    ...
    config = function(_, opts)
      ...
      -- set keymap for nvim-neo-tree
      vim.keymap.set('n', '<leader>to', function()
        vim.cmd ':Neotree show <CR>'
      end, { desc = 'Neo[T]ree [O]pen' })

      vim.keymap.set('n', '<leader>tc', function()
        vim.cmd ':Neotree close <CR>'
      end, { desc = 'Neo[T]ree [C]lose' })
  ...
  -- NOTE: install the indent blankline
  {
  ...
  -- NOTE: install vimtex for latex coding
  {
    'lervag/vimtex',
    init = function()

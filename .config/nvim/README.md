...
LazyVim is a Neovim setup powered to make easy to customize and extend your config.
...
Nvim-treesitter is a plugin that provide a simple and easy way to use the interface for tree-sitter in Neovim and provide some basic functionality such as hightlighting base on it.
So, the first thing you need to do is installing the tree-sitter-cli.

You can use cargo from rustup or npm to install tree-sitter-cli.
